...
class BarcodeEncoderTest {
    ...
    @Test fun upcA() = assertEquals(UPC_890497000030, bits("890497000030"))
    @Test fun ean13() = assertEquals(EAN_4006381333931, bits("4006381333931"))
    @Test fun rejectsBadChecksum() = assertNull(BarcodeEncoder.modules("890497000031"))

    companion object {
        const val UPC_890497000030 = "10101101110001011000110101000110001011011101101010111001011100101110010111001010000101110010101"
